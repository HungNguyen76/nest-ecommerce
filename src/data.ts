const heroapi = {
  ...
  videos: [
    { imgsrc: 'video/vcover1.png', clip: 'clip.mp4' },
    { imgsrc: 'video/vcover2.png', clip: 'clip.mp4' },
    { imgsrc: 'video/vcover3.png', clip: 'clip.mp4' },
  ],
  sociallinks: [
    { icon: 'facebook.svg', url: 'https://www.facebook.com/nike/' },
    { icon: 'messenger.svg', url: 'https://www.facebook.com/nike/' },
    { icon: 'instagram.svg', url: 'https://www.instagram.com/nike/' },
    { icon: 'twitter.svg', url: 'https://twitter.com/Nike' },
    { icon: 'youtube.svg', url: 'https://www.youtube.com/user/nike' },
  ],
};
  ...
  items: [
    {
      ...
      images: [
        {
          url: 'nike-adapt-bb-2.0/nike-adapt-bb-2.0-1.webp',
          filename: 'adapt-bb-2.0-1.jpg',
        },
        {
          url: 'nike-adapt-bb-2.0/nike-adapt-bb-2.0-2.webp',
          filename: 'adapt-bb-2.0-2.jpg',
        },
        {
          url: 'nike-adapt-bb-2.0/nike-adapt-bb-2.0-3.webp',
          filename: 'adapt-bb-2.0-3.jpg',
        },
        {
          url: 'nike-adapt-bb-2.0/nike-adapt-bb-2.0-4.webp',
          filename: 'adapt-bb-2.0-4.jpg',
        },
        {
          url: 'nike-adapt-bb-2.0/nike-adapt-bb-2.0-5.webp',
    ...
    },
    {
      ...
      images: [
        {
          url: 'martin-rose/martin-rose-1.webp',
          filename: 'martin-rose-1.webp',
        },
        {
          url: 'martin-rose/martin-rose-2.webp',
          filename: 'martin-rose-2.webp',
        },
        {
          url: 'martin-rose/martin-rose-3.webp',
          filename: 'martin-rose-3.webp',
        },
        {
          url: 'martin-rose/martin-rose-4.webp',
          filename: 'martin-rose-4.webp',
        },
        {
          url: 'martin-rose/martin-rose-5.webp',
    ...
    },
    {
      ...
      images: [
        {
          url: 'smart-shoe-2.0/smart-shoe-1.webp',
          filename: 'smart-shoe-2.0-1.jpg',
        },
        {
          url: 'smart-shoe-2.0/smart-shoe-4.jpg',
          filename: 'smart-shoe-2.0-2.jpg',
        },
        {
          url: 'smart-shoe-2.0/smart-shoe-5.jpg',
          filename: 'smart-shoe-2.0-3.jpg',
        },
        {
          url: 'smart-shoe-2.0/smart-shoe-6.jpg',
          filename: 'smart-shoe-2.0-4.jpg',
        },
        {
          url: 'smart-shoe-2.0/smart-shoe-7.jpg',
